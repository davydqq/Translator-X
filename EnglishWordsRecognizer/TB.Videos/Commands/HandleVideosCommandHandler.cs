...
public class HandleVideosCommandHandler : ICommandHandler<HandleVideosCommand, bool>
{
    ...
    public async Task<bool> HandleAsync(HandleVideosCommand command, CancellationToken cancellation = default)
    {
